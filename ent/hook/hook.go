...
// The AdditionalFieldFunc type is an adapter to allow the use of ordinary
// function as AdditionalField mutator.
type AdditionalFieldFunc func(context.Context, *ent.AdditionalFieldMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AdditionalFieldFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AdditionalFieldMutation); ok {
		return f(ctx, mv)
	}
...
// Mutate calls f(ctx, m).
func (f EmailChallengeFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.EmailChallengeMutation); ok {
		return f(ctx, mv)
	}

...
func (su *SessionUpdate) SetN(b []byte) *SessionUpdate {
	su.mutation.SetN(b)
	return su
}

// SetE sets the "e" field.
func (su *SessionUpdate) SetE(i int) *SessionUpdate {
	su.mutation.ResetE()
	su.mutation.SetE(i)
	return su
}
...
func (su *SessionUpdate) AddE(i int) *SessionUpdate {
	su.mutation.AddE(i)
	return su
}
...
func (su *SessionUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := su.mutation.N(); ok {
		_spec.SetField(session.FieldN, field.TypeBytes, value)
	}
	if value, ok := su.mutation.E(); ok {
		_spec.SetField(session.FieldE, field.TypeInt, value)
	}
	if value, ok := su.mutation.AddedE(); ok {
		_spec.AddField(session.FieldE, field.TypeInt, value)
	}
...
// SetN sets the "n" field.
func (suo *SessionUpdateOne) SetN(b []byte) *SessionUpdateOne {
	suo.mutation.SetN(b)
	return suo
}

// SetE sets the "e" field.
func (suo *SessionUpdateOne) SetE(i int) *SessionUpdateOne {
	suo.mutation.ResetE()
	suo.mutation.SetE(i)
	return suo
}
...
// AddE adds i to the "e" field.
func (suo *SessionUpdateOne) AddE(i int) *SessionUpdateOne {
	suo.mutation.AddE(i)
	return suo
}
...
func (suo *SessionUpdateOne) sqlSave(ctx context.Context) (_node *Session, err error) {
	...
	if value, ok := suo.mutation.N(); ok {
		_spec.SetField(session.FieldN, field.TypeBytes, value)
	}
	if value, ok := suo.mutation.E(); ok {
		_spec.SetField(session.FieldE, field.TypeInt, value)
	}
	if value, ok := suo.mutation.AddedE(); ok {
		_spec.AddField(session.FieldE, field.TypeInt, value)
	}

...
func AuthMiddleware() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if authToken == "" {
			c.JSON(http.StatusUnauthorized, gin.H{"error": gin.H{"code": "authRequired", "message": "Failed to authenticate user, invalid 'authToken' found in 'Authorization' header."}})
			c.Abort()
			return
		}
